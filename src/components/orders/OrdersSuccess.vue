    ...
    <div class="orderform">
      ...
      <form @submit.prevent="sendData">
        ...
        <div class="btns">
            ...
            <input class="btn" type="submit" value="나의 예약 수정하기" v-on:click="patchData()">
        </div>
  ...
  export default {
    ...
    methods: {
      async getData() {
        ...
        // if (number.data !== null) {
        //   this.$router.push(this.backend + "/orders/read?idx=" + this.idx);
        // }
        if (number.data !== null) {
          this.$router.push("/orders/read?idx= "+ this.idx);
        }
      },
      async deleteData() {
